...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    	String name=(String)session.getAttribute("userName");
	 	...
	 	ArrayList<UserOrderBean> lst=OrderDAO.displayNewOrder(cusId);
...
<body>
 	...
 	<table id="view">
		...
		<tr>
			...
			<td class="vtd"><a href="DeleteOrderAction.jsp?id=<%=obj.getId()%>">Cancel Order</a></td>
		</tr>
		 <%
		i=i+1; 
		} %>
